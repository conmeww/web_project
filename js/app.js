(() => {
    ...
    var heroTextReveal = new TimelineMax;
    heroTextReveal.from(".hero__content", 2, {
        delay: .5,
        y: 300,
        opacity: 0,
        ease: Elastic.easeOut.config(.3, .4)
    });
    var heroImgReveal = new TimelineMax;
    heroImgReveal.from(".hero-img", 1, {
        x: 500,
        opacity: 0
    }).to(".hero-img", 1, {
        delay: .5
    ...
    tl.from(".about__container h2", 1.5, {
        x: 200,
        opacity: 0
    }).from("img.about__img", 1, {
        y: 200,
        opacity: 0
    });
    ...
    tl2.from(".for-whom__container h2", 1.5, {
        x: 200,
        opacity: 0
    }).from(".for-whom__item img", 1, {
        opacity: 0,
        y: 200
    });
    ...
    tl3.from(".diagnoses__container h2", 1.5, {
        x: 200,
        opacity: 0
    });
    ...
    tl5.from(".product-cards__container h2", 1.5, {
        x: 200,
        opacity: 0
    });
    ...
    tl6.from(".order__container h2", 1.5, {
        x: 200,
        opacity: 0
    });
    ...
    tl7.from(".articles__container h2", 1.5, {
        x: 200,
        opacity: 0
    });
    ...
    function initSliders() {
        ...
        if (document.querySelector(".articles-slider")) new core(".articles-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
